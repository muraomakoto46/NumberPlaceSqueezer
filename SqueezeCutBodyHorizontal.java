...
public class SqueezeCutBodyHorizontal extends SqueezeAbstract implements InterfaceSqueeze {

	public SqueezeCutBodyHorizontal(Box[][] fields) {
		super(fields);
